...
FaceTrackApp is a sample application that demonstrates the face tracking, landmark tracking,
...
|--------------------------------------|-------------|
| `--app_mode = <mode>`                | Specifies the mode in which the app runs at startup:<br><br>- `0`: Face Detection and Tracking<br>- `1`: Facial Landmark Detection and Tracking<br>- `2`: Face 3D Mesh Fitting |
...
Keyboard Controls for the FaceTrack Sample Application
------------------------------------------------------

The FaceTrack sample application provides the following keyboard
