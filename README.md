...
Refer to the [Get Started on Windows](https://docs.nvidia.com/maxine/ar/latest/WindowsARSDK/Windows.html)
and [Get Started on Linux](https://docs.nvidia.com/maxine/ar/latest/LinuxARSDK/Linux.html) sections of the
[AR SDK Documentation](https://docs.nvidia.com/maxine/ar/index.html) for the list of supported GPUs, operating systems, and NVIDIA graphics driver versions.
...
The AR SDK is comprised of the SDK Core and a set of optional features that can be downloaded and installed individually.
...
To install the SDK Core and features, navigate to the [AR SDK Documentation](https://docs.nvidia.com/maxine/ar/index.html)
and follow the installation instructions for [Windows](https://docs.nvidia.com/maxine/ar/latest/WindowsARSDK/InstalltheARSDK.html)
or [Linux](https://docs.nvidia.com/maxine/ar/latest/LinuxARSDK/InstalltheARSDK.html).

#### AR SDK Features

Each sample application requires a particular set of AR SDK features to be installed. See the README.md file in each
